...
export const data = [
    {
        ...
        description: 'Safe Space is an app that will send you encouraging messages throughout the day.',
        image: '',
        githubRepo: 'https://github.com/safe-space-build-week/Micah',
        deploymentURL: 'https://safespacemj.netlify.com/',
    },
    {
        id: 2,
